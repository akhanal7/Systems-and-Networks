...
class ei(Instruction):
    ...
    @staticmethod
    def binary(operands, **kwargs):
        opcode = __zero_extend__(bin(ei.opcode()), OPCODE_WIDTH)
        return [__zero_extend__(opcode, BIT_WIDTH, pad_right=True)]

    @staticmethod
    def hex(operands, **kwargs):
        return [__bin2hex__(instr) for instr in ei.binary(operands, **kwargs)]
...
class di(Instruction):
    ...
    @staticmethod
    def binary(operands, **kwargs):
        opcode = __zero_extend__(bin(di.opcode()), OPCODE_WIDTH)
        return [__zero_extend__(opcode, BIT_WIDTH, pad_right=True)]

    @staticmethod
    def hex(operands, **kwargs):
        return [__bin2hex__(instr) for instr in di.binary(operands, **kwargs)]
...
class reti(Instruction):
    ...
    @staticmethod
    def binary(operands, **kwargs):
        opcode = __zero_extend__(bin(reti.opcode()), OPCODE_WIDTH)
        return [__zero_extend__(opcode, BIT_WIDTH, pad_right=True)]

    @staticmethod
    def hex(operands, **kwargs):
        return [__bin2hex__(instr) for instr in reti.binary(operands, **kwargs)]
